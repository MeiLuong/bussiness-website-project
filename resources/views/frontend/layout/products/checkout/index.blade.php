        ...
        <form action="" method="POST" style="display: flex">
            ...
            <div class="row">
                <div class="checkout-details col-8">
                    ...
                    <label>
                        <span class="lname label">Last Name <span class="required">*</span></span>
                    ...
                    <label>
                        <span class="label">Country <span class="required label">*</span></span>
                        <select name="country">
                    ...
                    <label>
                        <span class="label">Street Address <span class="required">*</span></span>
                        <input type="text" name="street_address" placeholder="House number and street name" required class="form-control">
                    </label>
                    <label>
                        <span>&nbsp;</span>
                        <input type="text" name="" placeholder="Apartment, suite, unit etc. (optional)" class="form-control">
                    </label>
                    <label>
                        <span class="label">Town / City <span class="required">*</span></span>
                        <input type="text" name="town_city" class="form-control">
                    </label>

                    <label>
                        <span class="label">Postcode / ZIP <span class="required">*</span></span>
                    ...
                    <label>
                        <span class="label">Email Address <span class="required">*</span></span>
                        <input type="email" name="email" class="form-control">
                    </label>
                    <input type="hidden" value="pending" name="status">
                </div>
                <div class="Yorder col-4">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td>Totals</td>
                            <td>
                                <strong class="theme-color">${{ $totals }}</strong>
                            </td>
                        </tr>
                    </table><br>
                    <div>
                        <input type="radio" name="payment_type" value="direct" id="direct" checked> Direct Bank Transfer
                    ...
                    <div>
                        <input type="radio" name="payment_type" id="cash" value="cash"> Cash on Delivery
                        <span class="checkmark"></span>
                    </div>
                    <div>
                        <input type="radio" name="payment_type" id="paypal" value="paypal"> Paypal <span>
                <span class="checkmark"></span>
      <img src="https://www.logolynx.com/images/logolynx/c3/c36093ca9fb6c250f74d319550acac4d.jpeg" alt="" width="50">
      </span>
                    </div>
                    <button type="submit" class="btn btn-full btn-primary btn-place-order">Place Order</button>
                </div>
            </div>
        </form>
    </div>
